...
/* Added uint16 datatypes to connect to test chains like ganache and hardhat*/

  contract MyRouter is RouterCrossTalk {
    ...
    function ExternalSetValue(uint16 _chainID , uint256 _value) public returns(bool) 
  {
